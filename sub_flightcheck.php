                    ...
                    <nav class="navbar navbar-expand-lg" id="tm-main-nav">
                        ...
                        <div class="collapse navbar-collapse tm-nav filter" id="navbar-nav">
                            <ul class="navbar-nav text-uppercase">
                                <li class="nav-item">
                                    <a class="nav-link tm-nav-link" href="sub_admin_homepage.php"><strong>Back To Homepage</strong></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link tm-nav-link" href="sub_admin_pnr.php"><strong>Check Ticket</strong></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link tm-nav-link" href="sub_flightlist.php"><strong>Check Another Flight Schedule</strong></a>
                                </li>
                            </ul>                            
                        </div>                        
                    </nav>
                ...
                <main class="tm-col-right tm-contact-main">
                  ...
                  <?php
                    ...
                    {                  
                      ...
                      //echo "<img style= 'text-align:center 'src='images/' class='img-thumbnail' width='180px' style='height:180px;'>";
                      //echo"<div>";
                    }
                  ?>
                </td>
