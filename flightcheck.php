                    ...
                    <nav class="navbar navbar-expand-lg" id="tm-main-nav">
                        ...
                        <div class="collapse navbar-collapse tm-nav filter" id="navbar-nav">
                            <ul class="navbar-nav text-uppercase">
                                <li class="nav-item">
                                    <a class="nav-link tm-nav-link" href="index.php"><strong>Back To Homepage</strong></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link tm-nav-link" href="login_page.php"><strong>Book Ticket</strong></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link tm-nav-link" href="flightlist.php"><strong>Check Another Flight Schedule</strong></a>
                                </li>
                            </ul>                            
                        </div>                        
                    </nav>
