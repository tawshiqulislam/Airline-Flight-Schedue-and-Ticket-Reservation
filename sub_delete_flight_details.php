        ...
        <div>
            ...
            <div class="tm-row">
                ...
                <h5 style="font-family: sarif">Welcome Staff!</h5>
                    ...
                    <h3 style="text-align:center" class="mb-5 tm-content-title">Delete Flight Schedule Details<hr></h3>
					<form action="sub_delete_flight_details_form_handler.php" method="post">
						<h5>ENTER THE FLIGHT SCHEDULE TO BE DELETED</h5>
						<div>
						<?php
