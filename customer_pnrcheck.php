                    ...
                    <nav class="navbar navbar-expand-lg" id="tm-main-nav">
                        ...
                        <div class="collapse navbar-collapse tm-nav filter" id="navbar-nav">
                            <ul class="navbar-nav text-uppercase">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link tm-nav-link" href="customer_pnr.php"><strong>Check Another Ticket</strong></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link tm-nav-link" href="customer_flightlist.php"><strong>Check Flight Schedule</strong></a>
                                </li>
                            </ul>                            
                        </div>                        
                    </nav>
