                    ...
                    <section class="tm-content tm-contact">
                        ...
                        <?php
							...
							if(isset($_POST['Submit']))
							{
								...
								$query="INSERT INTO Ticket_Details (pnr,date_of_reservation,flight_no,journey_date,class,booking_status,no_of_passengers,lounge_access,priority_checkin,insurance,payment_id) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
								$stmt=mysqli_prepare($dbc,$query);
								mysqli_stmt_bind_param($stmt,"ssssssissss",$pnr,$date_of_res,$flight_no,$journey_date,$class,$booking_status,$no_of_pass,$lounge_access,$priority_checkin,$insurance,$payment_id);
								mysqli_stmt_execute($stmt);
								...
								*/
								...
								header("location: sub_payment_details.php");
