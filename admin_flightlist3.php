...
if(isset($_REQUEST["u_sub"]))
{
    ...
    if($to!='')
    {
        $query=mysqli_query($con ,"select * from flight_details where to_city='".$to."'");
        $res=mysqli_fetch_row($query);
        $query0=mysqli_query($con ,"select * from flight_details where to_city='".$to."'");
        $res0=mysqli_fetch_row($query0);
        $query1=mysqli_query($con ,"select * from flight_details where to_city='".$to."'");
        $res1=mysqli_fetch_row($query1);

    if($res)
    {
        $_SESSION['user']=$to;
    header('location:admin_flightcheck3.php');
    }
    else
    {
        ...
        <div>
            ...
            <div class="tm-row">
                ...
                <main class="tm-col-right">
                    ...
                    <h3 style="text-align:center" class="mb-5 tm-content-title">Search Flight By Destination<hr></h3>
                    <form id="index" action="admin_flightlist3.php" method="post">
