...
if(isset($_REQUEST["u_sub"]))
{
    ...
    if($from!='')
    {
        $query=mysqli_query($con ,"select * from flight_details where from_city='".$from."'");
        $res=mysqli_fetch_row($query);
        $query0=mysqli_query($con ,"select * from flight_details where from_city='".$from."'");
        $res0=mysqli_fetch_row($query0);
        $query1=mysqli_query($con ,"select * from flight_details where from_city='".$from."'");
        $res1=mysqli_fetch_row($query1);

    if($res)
    {
        $_SESSION['user']=$from;
    header('location:admin_flightcheck2.php');
    }
    else
    {
        ...
        <div>
            ...
            <div class="tm-row">
                ...
                <main class="tm-col-right">
                    ...
                    <h3 style="text-align:center" class="mb-5 tm-content-title">Search Flight By Origin<hr></h3>
                    <form id="index" action="admin_flightlist2.php" method="post">
                        <div  id="divtop"><br>
                        <table cellpadding="5">
							<tr>
