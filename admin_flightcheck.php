            ...
            <tr class="list-table">  
              <td colspan="20" width="3%" >
                  <?php
                    ...
                    $result1 = mysqli_query($con,"SELECT * FROM flight_details WHERE departure_date='".$_SESSION['user']."' and from_city='".$_SESSION['user1']."' and to_city='".$_SESSION['user2']."'");
...
?>
        <div class="check_another">
          ...
          <h3><a href="admin_flightlist.php">Change Date or Origin or Destination</a></h3>
