                    ...
                    <nav class="navbar navbar-expand-lg" id="tm-main-nav">
                        ...
                        <div class="collapse navbar-collapse tm-nav filter" id="navbar-nav">
                            <ul class="navbar-nav text-uppercase">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link tm-nav-link" href="sub_admin_pnr.php"><strong>Change PNR</strong></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link tm-nav-link" href="sub_flightlist.php"><strong>Check Flight Schedule</strong></a>
                                </li>
                            </ul>                            
                        </div>                        
                    </nav>
