  ...
  <body>
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-12">
          <?php
          $q=mysqli_query($con,"SELECT * FROM flight_details WHERE from_city='".$_SESSION['user']."'");
          $n=  mysqli_fetch_assoc($q);
          $stname= $n['origin'];
          $id=$_SESSION['user'];
          
          $result = mysqli_query($con,"SELECT * FROM flight_details WHERE from_city='".$_SESSION['user']."'");
            ...
            <tr class="list-table">  
              <td colspan="20" width="3%" >
                  <?php
                    ...
                    $result1 = mysqli_query($con,"SELECT * FROM flight_details WHERE from_city='".$_SESSION['user']."'");
...
?>
        <div class="check_another">
          ...
          <h3><a href="admin_flightlist2.php">Change Origin</a></h3>
